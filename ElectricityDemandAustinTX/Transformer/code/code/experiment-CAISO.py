...
arg_dset = "caiso" #Choice of Spain: 'ree', AEP, DAYTON: 'dyt' London: 'lsm'
...
validation_out.to_csv("/home/lambpc/AMARANTH/opensourcegridmodeling/Transformer/code/code/Datasets/CAISO/caiso_out.csv")
