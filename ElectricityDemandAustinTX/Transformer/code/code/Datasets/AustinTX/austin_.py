...
# Austin is central so just a temp fix
...
if __name__ == '__main__':
    ...
    try:
        ...
        dset_root = "."
        output_filename = "austin_dict.pkl"
    
    f = open(os.path.join(dset_root,'austin_dict.csv'),'r')
    lines = f.readlines()
