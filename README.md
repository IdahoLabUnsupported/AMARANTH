...
In this repository, we develop the AMARANTH resilience measurement methodology and test it out on three different open source projects that are relatively close to the postulated AI use case within the grid sector. We include resilience measurements pre-adversarial action and post-adversarial action with resilience measurement helpers contained [here](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/tree/main/ResilienceMeasurementFramework?ref_type=heads). [AI Resilience Framework](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/blob/main/ResilienceMeasurementFramework/3.1.2_Measuring_Resilience_py.pdf?ref_type=heads) showcases how resilience was measured. [Attack Methodology and Framework](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/blob/main/ResilienceMeasurementFramework/3.1.3_Attack_Methodology_and_Framework_1_np.pdf?ref_type=heads) details the types of attacks conducted and measurement methodology. The following code bases exhibit open-source uses to this dataset and results across multiple files, architectures, and use cases.

## Electricity Demand Austin TX [Electricity Demand Forecasting](https://github.com/hvantil/ElectricityDemandForecasting)
...
In AMARANTH, we desconstruct this ipynb notebook and use the model to inference data between 2017 to 2024, determining when drift occurs through developed resilience means for multiple [models](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/tree/main/ElectricityDemandAustinTX/LoadForecastingAttacks/NormalModels?ref_type=heads). We additionally introduce attacks against each of the four models to determine the impact of the attacks recorded [here](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/tree/main/ElectricityDemandAustinTX/LoadForecastingAttacks/Attacks?ref_type=heads). 

## Smart Meter Load Disaggregation [Electricity Load Disaggregation](https://github.com/pipette/Electricity-load-disaggregation)
...
The AMARANTH team used this repository to determine the effects of adversarial action and the resilience of classification and disaggregation tasks for grid applications, determining when drift occurs through developed resilience means in [model-testing.ipynb](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/blob/main/Electricity-Load-Disaggregation/python_notebooks/model-testing.ipynb?ref_type=heads). We additionally introduce attacks against each of the four models to determine the impact of the attacks recorded [here](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/tree/main/Electricity-Load-Disaggregation/python_notebooks?ref_type=heads). 
...
Resilience measurement methodology is contained in [AI Resilience Framework](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/blob/main/ResilienceMeasurementFramework/3.1.2_Measuring_Resilience_py.pdf?ref_type=heads) and red teaming methodology is contained in [Attack Methodology and Framework](https://hpcgitlab.hpc.inl.gov/lambpc/opensourcegridmodeling/-/blob/main/ResilienceMeasurementFramework/3.1.3_Attack_Methodology_and_Framework_1_np.pdf?ref_type=heads).
